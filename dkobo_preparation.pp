...
# Since this is a repeatable task which won't be skipped, we will be keeping such items commented out and only execute manifest files in a specific order to avoid repeats.
exec { 'machine_prep' :
